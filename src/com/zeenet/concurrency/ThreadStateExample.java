...
class Threads implements Runnable {
	public void run() {
		...
		System.out.println("State of thread1 while it called join() method on thread2 -" + ThreadStateExample.thread1.getState());
		try {
			Thread.sleep(200);
		} catch (InterruptedException e) {
			e.printStackTrace();
...
public class ThreadStateExample implements Runnable {
	...
	public static ThreadStateExample obj;

	public static void main(String[] args) {
		obj = new ThreadStateExample();
